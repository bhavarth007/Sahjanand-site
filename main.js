    ...
    if (inquiryParam) {
      ...
      if (msgField && !msgField.value) {
        if (inqLower.indexOf('weaving') !== -1 || inqLower.indexOf('viving') !== -1) {
          msgField.value = 'Inquiry regarding Weaving Segment. Please provide quotation for grey cloth production, monthly meterage, and quality standards.';
        } else if (inqLower.indexOf('yarn') !== -1) {
          msgField.value = 'Inquiry regarding Yarn Segment. Please provide details on filament types, warping capacity, and supply timelines.';
          ...
          msgField.value = 'Inquiry regarding Trade Segment. Please provide details on raw polymer procurement, export grey cloth contracts, and commercial supply.';
